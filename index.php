            ...
            <div class="divTarjetas" id="btn-proyectos">
                ...
                <div class="tarjeta">
                    ...
                    <div class="parrafoTarj">
                        ...
                        <p>Sistema web para administrar productos y categorías. Incluye autenticación con roles y funciones específicas por usuario. Desarrollado con React y CSS en el frontend, y Django en el backend. Frontend desplegado en Vercel, backend en Koyeb y base de datos PostgreSQL en Neon</p>
                    </div> 
                    <div class="parrafoTarj2">
